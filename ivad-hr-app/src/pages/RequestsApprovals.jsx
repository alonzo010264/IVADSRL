...
const RequestsApprovals = () => {
  ...
  const requestTypes = [
    ...
    { id: 'aprobacion_vacaciones', label: 'Aprobación Vacaciones', path: '#' },
    { id: 'solicitudes_licencias', label: 'Solicitudes Licencias', path: '#' },
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex justify-center">
      <div className="p-4 w-full max-w-3xl">
        ...
        {/* Banner principal */}
        <div className="bg-[#0b1b3d] text-white rounded-2xl p-8 mb-6 flex flex-col items-center justify-center text-center shadow-lg relative overflow-hidden">
          ...
          <div className="bg-white/10 p-4 rounded-2xl relative z-10">
            <FileCheck size={64} className="text-[#f5a623]" strokeWidth={1.5} />
          </div>
          {/* Círculo decorativo */}
        ...
        {/* Título de sección */}
        <h2 className="text-xl font-bold text-[#0b1b3d] mb-4 px-1">Tipos de solicitud</h2>
        ...
        <div className="mt-4">
          <button 
            ...
            className="w-full bg-red-50 text-red-600 rounded-xl p-4 flex justify-center items-center shadow-sm border border-red-100 hover:bg-red-100 transition-colors font-semibold text-lg"
          >
            Cerrar Sesión
          </button>
        </div>
